...
public class VoteKick
{
    ...
    public void OnClientPutInServer(int playerSlot)
    {
        ...
        if(Configs.GetConfigData().VoteKick_Mode == 2 && Json_VoteKick.IsPlayerSteamIDRestricted(playerid, Configs.GetConfigData().VoteKick_TimeInMins, filename))
        {
            ...
            {
                Json_VoteKick.SaveToJsonFile(playerid, playername, PlayerIp!.ToString(), personDate, Configs.GetConfigData().VoteKick_EvasionPunishmentTimeInMins, Configs.GetConfigData().VoteKick_EvasionPunishmentTimeInMins, "Kick Evasion", filename);
                ...
                var replacerlogd = Helper.ReplaceMessages(Configs.GetConfigData().Log_DiscordMessageFormat, Date, Time, playername, playerid.ToString(), PlayerIp!.ToString(), "Kick Evasion");
    ...
    public HookResult OnEventPlayerConnectFull(EventPlayerConnectFull @event, GameEventInfo info)
    {
        ...
        if(!string.IsNullOrEmpty(Configs.GetConfigData().VoteKick_DisableItOnJoinTheseGroups) && Helper.IsPlayerInGroupPermission(player, Configs.GetConfigData().VoteKick_DisableItOnJoinTheseGroups))
        {
            if (!Globals_VoteKick.VoteKick_Disable.ContainsKey(playerid))
            {
                Globals_VoteKick.VoteKick_Disable.Add(playerid, true);
                Globals_VoteKick.VoteKick_Disabled = true;
            }
        }

        if(!string.IsNullOrEmpty(Configs.GetConfigData().VoteKick_ImmunityGroups) && Helper.IsPlayerInGroupPermission(player, Configs.GetConfigData().VoteKick_ImmunityGroups))
        {
        ...
        if (CenterMenuCommands.Any(cmd => cmd.Equals(message, StringComparison.OrdinalIgnoreCase)))
        {
            ...
            if(Configs.GetConfigData().VoteKick_TeamOnly)
            {
                if(CallerTeam == (byte)CsTeam.CounterTerrorist)
                {
                    ...
                    if (!string.IsNullOrEmpty(Configs.GetConfigData().VoteKick_DisableItOnJoinTheseGroups) && Globals_VoteKick.VoteKick_Disabled)
                    {
                        if (!string.IsNullOrEmpty(Localizer!["votekick.player.is.disabled"]))
                        {
                            Helper.AdvancedPrintToChat(Caller, Localizer["votekick.player.is.disabled"]);
                        }
                        return HookResult.Continue;
                    }
            ...
            if(Configs.GetConfigData().VoteKick_TeamOnly)
            {
                if (Globals_VoteKick.VoteKick_ShowMenuCT.ContainsKey(CallerSteamID) && Globals_VoteKick.VoteKick_ShowMenuCT[CallerSteamID] && Caller.TeamNum == (byte)CsTeam.CounterTerrorist)
                {
                    ...
                    if (Globals_VoteKick.VoteKick_GetVoted[Globals_VoteKick.VoteKick_targetPlayerNameCT] >= Globals_VoteKick.VoteKick_requiredct)
                    {
                        ...
                        {
                            Json_VoteKick.SaveToJsonFile(Globals_VoteKick.VoteKick_targetPlayerSTEAMCT, Globals_VoteKick.VoteKick_targetPlayerNameCT, Globals_VoteKick.VoteKick_targetPlayerIPCT!.ToString(), personDate, Configs.GetConfigData().VoteKick_TimeInMins, Configs.GetConfigData().VoteKick_TimeInMins, "Vote Kicked", filename);
                            ...
                            var replacerlogd = Helper.ReplaceMessages(Configs.GetConfigData().Log_DiscordMessageFormat, Date, Time, Globals_VoteKick.VoteKick_targetPlayerNameCT, Globals_VoteKick.VoteKick_targetPlayerSTEAMCT.ToString(), Globals_VoteKick.VoteKick_targetPlayerIPCT!.ToString(), "Vote Kicked");
                            if(Configs.GetConfigData().Log_SendLogToDiscordOnMode == 1)
                            {
                                if (!string.IsNullOrEmpty(Configs.GetConfigData().Log_DiscordMessageFormat))
                                {
                ...
                if (Globals_VoteKick.VoteKick_ShowMenuT.ContainsKey(CallerSteamID) && Globals_VoteKick.VoteKick_ShowMenuT[CallerSteamID] && Caller.TeamNum == (byte)CsTeam.Terrorist)
                {
                    ...
                    if (Globals_VoteKick.VoteKick_GetVoted[Globals_VoteKick.VoteKick_targetPlayerNameT] >= Globals_VoteKick.VoteKick_requiredt)
                    {
                        if (Configs.GetConfigData().VoteKick_Mode == 2 || Configs.GetConfigData().VoteKick_Mode == 3 || Configs.GetConfigData().VoteKick_Mode == 4)
                        {
                            Json_VoteKick.SaveToJsonFile(Globals_VoteKick.VoteKick_targetPlayerSTEAMT, Globals_VoteKick.VoteKick_targetPlayerNameT, Globals_VoteKick.VoteKick_targetPlayerIPT!.ToString(), personDate, Configs.GetConfigData().VoteKick_TimeInMins, Configs.GetConfigData().VoteKick_TimeInMins, "Vote Kicked", filename);
                            ...
                            var replacerlogd = Helper.ReplaceMessages(Configs.GetConfigData().Log_DiscordMessageFormat, Date, Time, Globals_VoteKick.VoteKick_targetPlayerNameT, Globals_VoteKick.VoteKick_targetPlayerSTEAMT.ToString(), Globals_VoteKick.VoteKick_targetPlayerIPT!.ToString(), "Vote Kicked");
                            if(Configs.GetConfigData().Log_SendLogToDiscordOnMode == 1)
                            {
                                if (!string.IsNullOrEmpty(Configs.GetConfigData().Log_DiscordMessageFormat))
                                {
            ...
            }else
            {
                if (Globals_VoteKick.VoteKick_ShowMenuBOTH.ContainsKey(CallerSteamID) && Globals_VoteKick.VoteKick_ShowMenuBOTH[CallerSteamID])
                {
                    ...
                    if (Globals_VoteKick.VoteKick_GetVoted[Globals_VoteKick.VoteKick_targetPlayerNameBOTH] >= Globals_VoteKick.VoteKick_requiredboth)
                    {
                        if (Configs.GetConfigData().VoteKick_Mode == 2 || Configs.GetConfigData().VoteKick_Mode == 3 || Configs.GetConfigData().VoteKick_Mode == 4)
                        {
                            Json_VoteKick.SaveToJsonFile(Globals_VoteKick.VoteKick_targetPlayerSTEAMBOTH, Globals_VoteKick.VoteKick_targetPlayerNameBOTH, Globals_VoteKick.VoteKick_targetPlayerIPBOTH!.ToString(), personDate, Configs.GetConfigData().VoteKick_TimeInMins, Configs.GetConfigData().VoteKick_TimeInMins, "Vote Kicked", filename);
                            ...
                            var replacerlogd = Helper.ReplaceMessages(Configs.GetConfigData().Log_DiscordMessageFormat, Date, Time, Globals_VoteKick.VoteKick_targetPlayerNameBOTH, Globals_VoteKick.VoteKick_targetPlayerSTEAMBOTH.ToString(), Globals_VoteKick.VoteKick_targetPlayerIPBOTH!.ToString(), "Vote Kicked");
                            if(Configs.GetConfigData().Log_SendLogToDiscordOnMode == 1)
                            {
                                if (!string.IsNullOrEmpty(Configs.GetConfigData().Log_DiscordMessageFormat))
                                {
    ...
    private void HandleMenuCT(CCSPlayerController Caller, ChatMenuOption option, int TargetPlayersUserID)
    {
        ...
        if (Globals_VoteKick.VoteKick_GetVoted[TargetPlayerName] >= requiredct)
        {
            if (Configs.GetConfigData().VoteKick_Mode == 2 || Configs.GetConfigData().VoteKick_Mode == 3 || Configs.GetConfigData().VoteKick_Mode == 4)
            {
                Json_VoteKick.SaveToJsonFile(TargetPlayerSteamID, TargetPlayerName, TargerIP!.ToString(), personDate, Configs.GetConfigData().VoteKick_TimeInMins, Configs.GetConfigData().VoteKick_TimeInMins, "Vote Kicked", filename);
                ...
                var replacerlogd = Helper.ReplaceMessages(Configs.GetConfigData().Log_DiscordMessageFormat, Date, Time, TargetPlayerName, TargetPlayerSteamID.ToString(), TargerIP!.ToString(), "Vote Kicked");
                if(Configs.GetConfigData().Log_SendLogToDiscordOnMode == 1)
                {
                    if (!string.IsNullOrEmpty(Configs.GetConfigData().Log_DiscordMessageFormat))
                    {
    ...
    public HookResult OnPlayerDisconnect(EventPlayerDisconnect @event, GameEventInfo info)
    {
        ...
        if (Globals_VoteKick.VoteKick_Disable.ContainsKey(playerid))
        {
            Globals_VoteKick.VoteKick_Disable.Remove(playerid);
            foreach (var allplayers in Helper.GetAllController())
            {
                ...
                if (!Globals_VoteKick.VoteKick_Disable.ContainsKey(playerssteamid))
                {
                    Globals_VoteKick.VoteKick_Disabled = false;
                }
            }
        }
        Globals_VoteKick.VoteKick_Immunity.Remove(playerid);
        return HookResult.Continue;
    }
