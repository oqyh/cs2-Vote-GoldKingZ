...
public class Json_VoteBanned
{
    ...
    public static void SaveToJsonFile(ulong PlayerSteamID, string PlayerName, string PlayerIPAddress, DateTime DateAndTime, int RestrictedForXDays, string Reason, string filename)
    {
        ...
        try
        {
            ...
            allPersonsData.RemoveAll(p => (DateTime.Now - p.DateAndTime).TotalDays > RestrictedForXDays);
